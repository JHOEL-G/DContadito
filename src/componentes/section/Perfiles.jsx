        ...
        <section className="relative py-28 bg-white overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-20">
                    <div className="inline-block px-6 py-2 rounded-full text-white text-xs font-bold uppercase tracking-widest mb-8"
                        style={{ background: '#93c01f' }}>
                        ¿A QUIÉN VA DIRIGIDO?
                    </div>

                    <h2 className="uppercase leading-none" style={{ color: '#152036' }}>
                        <span className="block text-5xl md:text-6xl font-light tracking-tight">
                            DISEÑADO PARA
                        </span>
