...
const Sucursales = () => {
    ...
    return (
        <section id="sucursales" className="relative py-12 sm:py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="text-center mb-8 sm:mb-12 space-y-3 sm:space-y-4">
                    ...
                    <h2 className="text-3xl sm:text-5xl md:text-7xl font-light text-[#1d2d5b] uppercase tracking-tight leading-none">
                        PRESENCIA <br />
                        <span className="text-4xl sm:text-6xl md:text-9xl font-black block mt-2 text-[#284a80]">NACIONAL</span>
                    </h2>
                    <p className="text-gray-600 text-base sm:text-lg md:text-xl font-light mt-4 sm:mt-6 max-w-3xl mx-auto">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                    {sucursales.map((s) => (
                        <div
                            key={s.estado}
                            className="bg-white border-2 border-[#3fb4e9]/20 rounded-[1.5rem] sm:rounded-[2.5rem] p-5 sm:p-8 text-center transition-all hover:border-[#3fb4e9] hover:shadow-lg group"
                        >
                            <h3 className="text-sm sm:text-lg font-black text-[#1d2d5b] uppercase tracking-tighter mb-3 sm:mb-4">
                                {s.estado}
                            </h3>
                            <div className="space-y-1">
                                {s.ciudades.map((c) => (
                                    <p key={c} className="text-xs sm:text-sm font-medium text-gray-500 leading-tight">
                                        {c}
                                    </p>
                                ))}
                            </div>
