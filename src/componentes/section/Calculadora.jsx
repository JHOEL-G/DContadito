...
const Calculadora = ({ monto, setMonto, quincenas, setQuincenas, pagoQuincenal, totalPagar, intereses, fmt, handleSolicitar }) => {
    ...
    return (
        <section id="calculadora" className="relative py-20 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16 space-y-4">
                    ...
                    <h2 className="text-5xl md:text-7xl font-light text-[#1d2d5b] uppercase tracking-tight leading-none">
                        ¿CUÁNTO <br />
                        <span className="text-6xl md:text-9xl font-black block mt-2">NECESITAS?</span>
                    </h2>
                ...
                <div className="relative flex flex-col lg:flex-row items-center gap-2">
                    ...
                    <div className="w-full lg:w-[80%] bg-[#93c01f] rounded-[3rem] p-8 md:p-14 shadow-xl relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex justify-between items-end text-[#1d2d5b]">
                                    ...
                                    <span className="text-5xl font-black tracking-tighter">{fmt(monto)}</span>
                                </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex justify-between items-end text-[#1d2d5b]">
                                    ...
                                    <span className="text-5xl font-black tracking-tighter">
                                        {quincenas}<span className="text-2xl ml-1">Q</span>
                                    </span>
                                </div>
                                <div className="relative h-6 flex items-center">
                                    <div className="absolute w-full h-[3px] bg-[#1d2d5b] rounded-full opacity-30"></div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
                            {[
                                ...
                                <div key={r.label} className="bg-white rounded-[1.5rem] p-8 text-center shadow-sm hover:shadow-md transition-shadow">
                                    <span className={`block text-4xl font-black tracking-tighter ${r.color} mb-1`}>
                                        {r.val}
                                    </span>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-4 border-t border-[#1d2d5b]/10">
                            <p className="text-[12px] text-[#1d2d5b] leading-tight max-w-sm font-medium">
                            ...
                            <button
                                ...
                                className="bg-[#3fb4e9] text-white px-12 py-5 rounded-2xl font-black text-[13px] uppercase tracking-widest hover:bg-[#1d2d5b] hover:-translate-y-1 transition-all shadow-xl active:scale-95"
                            >
