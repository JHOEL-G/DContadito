        ...
        <section className="relative py-20 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-12 space-y-4">
                    ...
                    <h2 className="text-5xl md:text-7xl font-light text-[#152036] uppercase tracking-tight leading-none">
                        TRANSPARENCIA <br />
                        <span className="text-6xl md:text-9xl font-black block mt-2 text-[#284a80]">TOTAL</span>
                    </h2>
                </div>
                ...
                <div className="space-y-3 mb-12">
                    {normativas.map((texto, i) => (
                        <div
                            key={i}
                            className="flex items-center gap-6 bg-[#93c01f] rounded-xl p-4 md:px-8 transition-transform hover:scale-[1.01]"
                        >
                            <span className="text-3xl md:text-4xl font-black italic text-[#1d2d5b]">
                                0{i + 1}
                            </span>
                            <p className="text-sm md:text-base font-medium text-[#1d2d5b] leading-tight">
                                {texto}
                            </p>
                        </div>
                    ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-[#152036] rounded-[2.5rem] p-10 text-center text-white flex flex-col items-center justify-center space-y-4">
                        <h4 className="text-xl font-black uppercase tracking-tighter">CONDUSEF</h4>
                    ...
                    <div className="bg-[#152036] rounded-[2.5rem] p-10 text-center text-white flex flex-col items-center justify-center space-y-4">
                        <h4 className="text-xl font-black uppercase tracking-tighter">AVISO COBRANZA</h4>
